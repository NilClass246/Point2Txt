...
from .PointE.model import load_point_e
...
class SDModel(PreTrainedModel):
    ...
    def __init__(
        ...
        self.bert_model = load_point_BERT().to(self._device)
    ...
    def generate_points(self, points):
        ...
        encoder_outputs = self.bert_model(points)
    ...
    def get_conditional_context(self, points, batch_size=None):
        ...
        # ============= replace this part with custom decoder  =============
